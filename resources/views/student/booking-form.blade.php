    ...
    <div class="p-6 max-w-5xl mx-auto space-y-6">
        ...
        <div class="max-w-3xl mx-auto pb-4">
            <div class="flex items-center justify-between relative">
                ...
                <div id="wizard-progress-bar" class="absolute left-0 top-1/2 -translate-y-1/2 h-0.5 bg-indigo-600 transition-all duration-300 z-0" style="width: 0%;"></div>

                <div class="flex flex-col items-center relative z-10">
                    <div id="step-circle-1" class="w-9 h-9 rounded-full bg-indigo-600 text-white font-bold flex items-center justify-center text-sm shadow-xs transition duration-300">
                        1
                    </div>
                ...
                <div class="flex flex-col items-center relative z-10">
                    <div id="step-circle-2" class="w-9 h-9 rounded-full bg-white text-gray-400 border-2 border-gray-200 font-bold flex items-center justify-center text-sm transition duration-300">
                        2
                    </div>
                    ...
                    <form action="/bookings" method="POST" id="wizard-form" class="space-y-5 my-auto">
                        ...
                        <div id="wizard-step-1" class="space-y-5 transition-opacity duration-200">
                            <div>
                                ...
                                <p class="text-xs text-gray-400 mb-4">Tentukan kelas yang ingin Anda ikuti untuk mengamankan slot belajar.</p>
                            </div>
                            ...
                            <div>
                                <label for="course_select" class="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1.5">Kelas yang Dipilih <span class="text-rose-500">*</span></label>
                                <select name="course_id" id="course_select" required
                                    ...
                                    <option value="" data-price="0" data-teacher="-" data-category="-">-- Pilih Program Kelas --</option>
                            ...
                            <div>
                                ...
                                <textarea name="note" id="student_note" rows="3" placeholder="Contoh: Saya ingin belajar dari dasar karena belum familiar dengan framework ini..."
                        ...
                        <div id="wizard-step-2" class="space-y-5 hidden transition-opacity duration-200">
                            <div>
                            ...
                            <div class="p-4 bg-gray-50 border border-gray-200 rounded-xl flex items-center justify-between gap-4">
                                <div class="space-y-1">
                                    <span class="text-[10px] font-bold text-blue-800 tracking-wider">BANK MANDIRI</span>
                                ...
                                <button type="button" onclick="copyToClipboard('norek-mandiri', this)" class="px-3 py-1.5 bg-white border border-gray-200 hover:bg-gray-100 rounded-lg text-xs font-semibold text-gray-600 shadow-2xs transition flex items-center gap-1">
                                    Salin
                                </button>
                            </div>
                            ...
                            <div class="p-4 bg-gray-50 border border-gray-200 rounded-xl flex items-center justify-between gap-4">
                                <div class="space-y-1">
                                    <span class="text-[10px] font-bold text-blue-600 tracking-wider">BANK BCA</span>
                                    <p class="text-sm font-mono font-bold text-gray-800 tracking-wide" id="norek-bca">0561122334</p>
                                    <p class="text-[11px] text-gray-400">Atas Nama: <span class="font-semibold text-gray-600">Guru Hub Media</span></p>
                                </div>
                                <button type="button" onclick="copyToClipboard('norek-bca', this)" class="px-3 py-1.5 bg-white border border-gray-200 hover:bg-gray-100 rounded-lg text-xs font-semibold text-gray-600 shadow-2xs transition flex items-center gap-1">
                                    Salin
                                </button>
                            </div>
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-50">
                            <button type="button" id="btn-back" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 text-xs font-semibold rounded-xl transition opacity-0 cursor-default">
                                Kembali
                            </button>

                            <button type="button" id="btn-next" class="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl shadow-xs transition flex items-center gap-2">
                ...
                <div class="bg-white p-5 rounded-2xl shadow-2xs border border-gray-100 space-y-4 sticky top-6">
                    ...
                    <div class="bg-indigo-600 text-white p-4 rounded-xl space-y-1 shadow-sm mt-2">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button" id="btn-copy-price" disabled class="px-2 py-1 bg-indigo-500/50 hover:bg-indigo-500 border border-indigo-400/30 text-[10px] font-semibold rounded-md transition opacity-0 cursor-default">
                                Salin
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="bg-indigo-50/50 p-3 rounded-xl text-[11px] text-indigo-700 leading-normal flex gap-2">
                        ...
                        <span id="summary-info-text">Pilih program kelas terlebih dahulu untuk melihat instruksi lengkap detail transaksi pendaftaran.</span>
                    </div>
                </div>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            btnNext.addEventListener('click', function() {
                if (currentStep === 1) {
                    ...
                    summaryInfoText.textContent = "Silakan lakukan transfer sesuai nomor rekening tertera sebelum mengirim pendaftaran agar verifikasi berjalan cepat.";
            ...
            btnBack.addEventListener('click', function() {
                if (currentStep === 2) {
                    ...
                    summaryInfoText.textContent = "Pilih program kelas terlebih dahulu untuk melihat instruksi lengkap detail transaksi pendaftaran.";
                }
            });
