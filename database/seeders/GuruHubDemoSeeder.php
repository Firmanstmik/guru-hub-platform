...
class GuruHubDemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['name' => 'courses-add', 'controller' => 'CourseController', 'uri' => '/courses', 'method' => 'post', 'action' => 'store', 'roles' => ['admin']],
            ['name' => 'courses-edit', 'controller' => 'CourseController', 'uri' => '/courses/{course}', 'method' => 'put', 'action' => 'update', 'roles' => ['admin']],
            ['name' => 'courses-hapus', 'controller' => 'CourseController', 'uri' => '/courses/{course}', 'method' => 'delete', 'action' => 'destroy', 'roles' => ['admin']],
